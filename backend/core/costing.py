...
def post(*, site, cost_head, state, source, amount, posted_on=None,
    ...
    if reversal_of is not None:
        ...
        vehicle = vehicle or reversal_of.vehicle
...
FOREX = "FOREX"
# Trading book (TRADING_BUILD_BRIEF.md §5) — seeded by migration 0245.
TRD_COGS = "TRD_COGS"
TRD_REVENUE = "TRD_REVENUE"
TRD_OUTPUT_GST = "TRD_OUTPUT_GST"
TRD_FREIGHT = "TRD_FREIGHT"
# Rental book (MARINE_BUILD_BRIEF.md §4) — seeded by migration 0251.
RNT_REVENUE = "RNT_REVENUE"
RNT_MAINTENANCE = "RNT_MAINTENANCE"
RNT_FUEL = "RNT_FUEL"
RNT_OPERATOR = "RNT_OPERATOR"
RNT_INSURANCE = "RNT_INSURANCE"
RNT_OUTPUT_GST = "RNT_OUTPUT_GST"
