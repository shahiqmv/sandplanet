...
urlpatterns = [
    ...
    path("auth/sso", views.auth_sso, name="auth-sso"),
    path("auth/peer-verify", views.auth_peer_verify, name="auth-peer-verify"),
    ...
    path("hse/permits", hse_api.permits, name="hse-permits"),
    path("hse/permits/<str:ref>/close", hse_api.permit_close,
         name="hse-permit-close"),
    path("hse/risk-assessments", hse_api.risk_assessments,
         name="hse-risk-assessments"),
    path("hse/inspections", hse_api.inspections, name="hse-inspections"),
    ...
    path("projects/<int:pk>/handover/snags", handover_api.snags,
         name="handover-snags"),
    path("projects/<int:pk>/handover/transmittals",
         handover_api.transmittals, name="handover-transmittals"),
    path("projects/<int:pk>/handover/transmittals/candidates",
         handover_api.transmittal_candidates,
         name="handover-transmittal-candidates"),
    path("handover/transmittals/<int:pk>", handover_api.transmittal_detail,
         name="handover-transmittal"),
    path("handover/transmittals/<int:pk>/issue",
         handover_api.transmittal_issue, name="handover-transmittal-issue"),
    path("handover/transmittals/<int:pk>/transmittal.pdf",
         handover_api.transmittal_pdf, name="handover-transmittal-pdf"),
    path("handover/transmittal-lines/<int:pk>/response",
         handover_api.transmittal_response,
         name="handover-transmittal-response"),
    ...
    path("company/brand/<str:kind>", views.company_brand_file, name="company-brand-file"),
    path("brand", views.brand_public, name="brand"),
    ...
    path("tenders/<int:pk>/boq", tenders_api.tender_boq, name="tender-boq"),
    path("tenders/<int:pk>/boq/items", tenders_api.tender_boq_save,
         name="tender-boq-save"),
    path("tenders/<int:pk>/quotes", tenders_api.tender_quotes,
         name="tender-quotes"),
    path("tenders/<int:pk>/quotes/<int:quote_id>",
         tenders_api.tender_quote_delete, name="tender-quote-delete"),
    path("tenders/<int:pk>/boq/items/<int:item_id>/workings",
         tenders_api.tender_boq_item_workings, name="tender-boq-workings"),
    path("tenders/<int:pk>/boq/workings/search",
         tenders_api.tender_workings_search, name="tender-workings-search"),
    path("tenders/<int:pk>/boq/capture", tenders_api.tender_boq_capture,
         name="tender-boq-capture"),
    path("tenders/<int:pk>/boq/capture/draft", tenders_api.tender_boq_draft,
         name="tender-boq-draft"),
    path("tenders/<int:pk>/boq/template", tenders_api.tender_boq_template,
         name="tender-boq-template"),
    path("tenders/<int:pk>/boq/import", tenders_api.tender_boq_import,
    ...
    path("tenders/<int:pk>/events/<int:event_id>/photo",
         tenders_api.tender_event_photo, name="tender-event-photo"),
    path("tenders/<int:pk>/documents", tenders_api.tender_documents,
         name="tender-documents"),
    path("tenders/<int:pk>/documents/<int:att_id>",
         tenders_api.tender_document_delete, name="tender-document-delete"),
    path("tenders/<int:pk>/digest", tenders_api.tender_digest,
         name="tender-digest"),
    path("tenders/<int:pk>/digest/raise-queries",
         tenders_api.tender_digest_raise_queries,
         name="tender-digest-raise-queries"),
    ...
    path("shipments", imports_api.shipments_module, name="shipments-module"),
    path("shipments/cargo-options", imports_api.shipment_cargo_options,
         name="shipment-cargo-options"),
    ...
    # A DMA sheet for one project's client team, general rows included
    path("dma/<str:ref>/report.pdf", docs.dma_report_pdf, name="dma-report-pdf"),
    ...
    path("projects/<int:pk>/unit-stages", units_api.project_stages,
    ...
    path("attendance/shift-assign", hr.shift_assign, name="shift-assign"),
    ...
    path("sites/<int:site_id>/attendance.pdf", hr.attendance_range_pdf,
         name="attendance-range-pdf"),
    ...
    path("procurement-schedule-lines/<int:line_id>/delivered",
         psched_api.schedule_line_delivered, name="psc-line-delivered"),
    ...
    path("trading/users", trading_api.sales_users, name="trading-users"),
    path("trading/orders", trading_api.orders, name="trading-orders"),
    path("trading/orders/<int:pk>", trading_api.order_detail,
         name="trading-order"),
    path("trading/orders/<int:pk>/lines", trading_api.order_lines,
         name="trading-order-lines"),
    path("trading/orders/<int:pk>/stage", trading_api.order_stage,
         name="trading-order-stage"),
    path("trading/orders/<int:pk>/quotations", trading_api.order_quotations,
         name="trading-order-quotations"),
    path("trading/orders/<int:pk>/quotations/<int:qid>/authorise",
         trading_api.quotation_authorise, name="trading-quotation-authorise"),
    path("trading/orders/<int:pk>/quotations/<int:qid>/withdraw",
         trading_api.quotation_withdraw, name="trading-quotation-withdraw"),
    path("trading/orders/<int:pk>/quotations/<int:qid>/pdf",
         trading_api.quotation_pdf, name="trading-quotation-pdf"),
    path("trading/orders/<int:pk>/won", trading_api.order_won,
         name="trading-order-won"),
    path("trading/orders/<int:pk>/lost", trading_api.order_lost,
    ...
    path("trading/orders/<int:pk>/deliveries", trading_api.order_deliveries,
         name="trading-order-deliveries"),
    path("trading/orders/<int:pk>/deliveries/<int:did>", trading_api.delivery_detail,
         name="trading-delivery"),
    path("trading/orders/<int:pk>/deliveries/<int:did>/receive",
    ...
    path("trading/orders/<int:pk>/invoices/<int:iid>", trading_api.invoice_action,
         name="trading-invoice-action"),
    path("trading/orders/<int:pk>/invoices/<int:iid>/pdf", trading_api.invoice_pdf,
         name="trading-invoice-pdf"),
    path("trading/invoices/historic", trading_api.historic_invoices,
         name="trading-historic-invoices"),
    path("trading/invoices/historic/<int:iid>/void", trading_api.historic_invoice_void,
         name="trading-historic-invoice-void"),
    path("trading/receipts", trading_api.receipts, name="trading-receipts"),
    path("trading/receipts/allocate", trading_api.receipt_allocate,
         name="trading-receipt-allocate"),
    ...
    path("fleet/customers", fleet_api.customers, name="fleet-customers"),
    path("fleet/customers/<int:pk>", fleet_api.customer_detail, name="fleet-customer"),
    path("fleet/project-clients", fleet_api.project_clients, name="fleet-project-clients"),
    path("fleet/agreements", fleet_api.agreements, name="fleet-agreements"),
    path("fleet/agreements/<int:pk>", fleet_api.agreement_detail, name="fleet-agreement"),
    path("fleet/agreements/<int:pk>/vehicles", fleet_api.agreement_vehicles,
         name="fleet-agreement-vehicles"),
    path("fleet/agreements/<int:pk>/action", fleet_api.agreement_action,
         name="fleet-agreement-action"),
    path("fleet/agreements/<int:pk>/pdf", fleet_api.agreement_pdf, name="fleet-agreement-pdf"),
    path("fleet/agreements/<int:pk>/register", fleet_api.agreement_register,
         name="fleet-agreement-register"),
    path("fleet/agreements/<int:pk>/register/approve", fleet_api.agreement_register_approve,
         name="fleet-agreement-register-approve"),
    path("fleet/terms", fleet_api.rental_terms, name="fleet-terms"),
    path("fleet/agreements/<int:pk>/invoices", fleet_api.agreement_invoices,
         name="fleet-agreement-invoices"),
    path("fleet/invoices", fleet_api.invoices, name="fleet-invoices"),
    path("fleet/invoices/<int:iid>", fleet_api.invoice_detail, name="fleet-invoice"),
    path("fleet/invoices/<int:iid>/pdf", fleet_api.invoice_pdf, name="fleet-invoice-pdf"),
    path("fleet/receipts", fleet_api.receipts, name="fleet-receipts"),
    path("fleet/receipts/allocate", fleet_api.receipt_allocate, name="fleet-receipt-allocate"),
    path("fleet/receipts/<int:rid>", fleet_api.receipt_detail, name="fleet-receipt"),
    path("fleet/receivables", fleet_api.receivables, name="fleet-receivables"),
    path("fleet/customers/<int:cid>/statement", fleet_api.customer_statement,
         name="fleet-customer-statement"),
    path("fleet/vehicles/<int:pk>/jobs", fleet_api.vehicle_jobs, name="fleet-vehicle-jobs"),
    path("fleet/vehicles/<int:pk>/costs", fleet_api.vehicle_costs, name="fleet-vehicle-costs"),
    path("fleet/jobs", fleet_api.jobs, name="fleet-jobs"),
    path("fleet/jobs/<int:jid>", fleet_api.job_detail, name="fleet-job"),
