...
urlpatterns = [
    ...
    path("auth/notification-settings", views.auth_notification_settings,
         name="auth-notification-settings"),
    path("notify/config", views.notify_config, name="notify-config"),
    path("notify/test", views.notify_test, name="notify-test"),
