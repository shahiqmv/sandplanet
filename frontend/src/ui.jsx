...
const ICON_PATHS = {
  // Unit progress: a grid of units, some filled.
  grid: <><rect x="3" y="3" width="7" height="7" rx="1" />
    <rect x="14" y="3" width="7" height="7" rx="1" />
    <rect x="3" y="14" width="7" height="7" rx="1" />
    <rect x="14" y="14" width="7" height="7" rx="1" /></>,
  // Submittals: a clipboard with a tick — something sent out and signed off.
  clipboard: <><path d="M9 3h6a1 1 0 0 1 1 1v1H8V4a1 1 0 0 1 1-1z" />
...
const STATUS_TONES = {
  ...
  AWARDED: "info", TENDERING: "info",
  ISSUED: "info", SUBMITTED: "info", PM_APPROVED: "info",
